...
namespace FinPortal.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "Id,HouseholdId,RecipientId,Subject,Body,Created,IsRead,MyProperty")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,HouseholdId,RecipientId,Subject,Body,Created,IsRead,MyProperty")] Notification notification)
        {
            if (ModelState.IsValid)
            {
